...
time_up_message_path = r"C:\Users\HP\Downloads\alarm-tone-41440.wav"
...
def handle_api_request(json_response):
    ...
    if module == "Weather":
        ...
        engine.say("Sure, I'll take a picture now, Keep Smiling.")
        engine.runAndWait()
...
def main():
    ...
    engine.say("Hey There , How can I assist you today?")
    engine.runAndWait()
